...
class StoreCommodityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type_series' => 'required|string|min:3|max:255',
            'brand' => 'required|string|min:2|max:255',
            'year_of_purchase' => 'nullable|numeric|digits:4',
    ...
    public function messages(): array
    {
        return [
            ...
            'type_series.required' => 'Kolom tipe barang wajib diisi!',
            'type_series.string' => 'Kolom tipe barang harus berupa karakter!',
            'type_series.min' => 'Kolom tipe barang minimal :min karakter!',
            'type_series.max' => 'Kolom tipe barang maksimal :max karakter!',
