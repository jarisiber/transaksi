<!-- Modal -->
<div class="modal fade" id="kredensial_penggunas_create_modal" data-backdrop="static" data-keyboard="false"
	tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">Tambah Data Kredensial Pengguna</h5>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								<label for="name">Nama/ID Pengguna<span class="font-weight-bold text-danger">*</span></label>
								<input type="text" name="name" class="form-control @error('name', 'store') is-invalid @enderror"
									id="name" value="{{ old('name') }}" placeholder="Masukan nama/ID..">
								@error('name', 'store')
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label for="description">Keterangan <span class="font-italic">(opsional)</span></label>
