		...
		<section class="section">
			<div class="d-flex flex-wrap align-items-stretch">
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						<h5 class="text-dark font-weight-normal pt-5 mt-5">Inventory <span class="font-weight-bold">Jari Siber Teknologi</span></h5>
				...
				<div
					...
					data-background="../assets/img/unsplash/kr.jpg">
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							...
							Photo by <a class="text-light bb" target="_blank" href="https://unsplash.com/photos/a8lTjWJJgLA"> Degleex Ganzorig
