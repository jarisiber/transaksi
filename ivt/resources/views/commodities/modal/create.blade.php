			...
			<div class="modal-body">
				...
				<form action="{{ route('barang.store') }}" method="POST">
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div class="form-group">
								...
								<input type="text" class="form-control @error('name', 'store') is-invalid @enderror" name="name"
									id="name" value="{{ old('name') }}" placeholder="Cth: HDD">
								@error('name', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
						...
						<div class="col-lg-3">
							<div class="form-group">
								<label for="type_series">Tipe Barang<span class="font-weight-bold text-danger">*</span></label>
								<input type="text" class="form-control @error('type_series', 'store') is-invalid @enderror" name="type_series"
									id="type_series" value="{{ old('type_series') }}" placeholder="Cth: L3110">
								@error('type_series', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
								@enderror
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label for="date_of_purchase">Tanggal Pembelian<span class="font-weight-bold text-danger">*</span></label>
								<input type="date" class="form-control @error('date_of_purchase', 'store') is-invalid @enderror"
									name="date_of_purchase" id="date_of_purchase" value="{{ old('date_of_purchase') }}"
									placeholder="Masukan tanggal pembelian barang..">
								@error('date_of_purchase', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
								@enderror
